  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center gap-3 pb-4 border-b border-gray-200">
        ...
        <div>
          <h3 className="font-semibold text-gray-900">Oscillator Node</h3>
          <p className="text-sm text-gray-500">Generate audio waveforms</p>
        </div>
      </div>
      ...
      <div className="space-y-2">
        ...
        <div className="flex justify-between text-sm">
          <span className="text-gray-500">20 Hz</span>
          <span className="text-gray-900 font-medium">
            {node.data.frequency} Hz
          </span>
          <span className="text-gray-500">2000 Hz</span>
        </div>
      </div>
      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          <select
            ...
            className="w-full appearance-none bg-white border border-gray-200 rounded-lg px-3 py-2 pr-8 text-gray-900 cursor-pointer focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500"
          >
